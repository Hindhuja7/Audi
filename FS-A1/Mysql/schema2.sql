...
insert into student2 values(102,2, NULL,50); /* Invalid */
...
insert into customer (custid,aadharno,phone) values(51,'Adhar51',55667788995566778899);

alter table customer change city town varchar(20);

alter table customer add column city4 varchar(10) not null
after city;
