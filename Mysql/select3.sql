...
select (timestampdiff(year,'2020-10-10',sysdate())) ;

select timestampdiff(day,'2008-10-10',sysdate());

select timestampdiff(day,'2016-11-24',sysdate());

select timestampdiff(hour,'2016-11-24',sysdate());